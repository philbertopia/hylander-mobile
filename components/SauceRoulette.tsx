...
export function SauceRoulette() {
  ...
  return (
    <section className="mx-auto mt-16 grid w-full max-w-[760px] justify-items-center max-sm:mt-12" aria-label="Sauce Roulette">
      <article className="relative grid w-full gap-2 overflow-visible rounded-lg border-2 border-hyGreen bg-cover bg-center p-3 text-white shadow-[0_18px_44px_rgba(7,7,12,0.28),4px_4px_0_#12b76a]" style={{ backgroundImage: "url('/img/roulette/ChatGPT Image May 18, 2026, 03_11_10 PM.png?v=20260519')" }} data-animate="card">
